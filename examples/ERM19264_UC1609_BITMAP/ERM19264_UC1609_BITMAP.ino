...
uint8_t fullscreenBuffer[MYLCDWIDTH * (MYLCDHEIGHT / 8) + 1] = {
  ...
  void loop()
  {
    ...
    while (1)
    {
      ...
      // test (2)
#ifdef test2
      mylcd.LCDBuffer(50, 10, 20, 20, (uint8_t*)smallBitmapNPM);
      mylcd.LCDBuffer(112, 10, 20, 20, (uint8_t*)smallBitmapNPM);
      while (1) {
        delay(5000);
      };
#endif
      ...
      mylcd.drawBitmap(0, 0, smallBitmap, 20, 20, FOREGROUND, BACKGROUND);
      mylcd.drawBitmap(30, 20, smallBitmap, 20, 20, BACKGROUND, FOREGROUND);
      ...
      mylcd.drawBitmap(0, 0, smallBitmapHa, 20, 20, FOREGROUND, BACKGROUND);
